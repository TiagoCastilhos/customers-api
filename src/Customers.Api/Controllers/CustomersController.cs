...
public class CustomersController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(string), 404, contentType: "text/plain")]
    ...
    [ProducesResponseType(typeof(CustomerOutputModel), 200, contentType: "application/json")]
    [ProducesResponseType(typeof(string), 400, contentType: "text/plain")]
    [ProducesResponseType(typeof(string), 409, contentType: "text/plain")]
    ...
    {
        await _customersService.UpdateAsync(email, customerInputModel);
        return Ok();
    }
